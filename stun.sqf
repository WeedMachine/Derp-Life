...
if(player distance copbase1 < 150 and iscop and vehicle player == player) exitwith
...
if(player distance civspawn < 100 and _wep != "M1014" and _wep != "Makarov" and _wep != "Bizon_Silenced") exitwith																																																		
...
if(vehicle player != player)then{player Action ["eject", vehicle player]; sleep 0.5;};
