...
INV_action_carfacablage     = player addaction ["Carstorage", "carstorage.sqf", [_ablage, "public"]];																																																									
...
INV_action_facworkers2 = player addaction [format["Buy factory 10 workers ($50000)", facworkercost], "facqueue2.sqf", _i];
if (_a3 == 1) then {player removeaction INV_action_facbuy;};																																																								
_a2 = 1;																				
_f2 = _i;	};																																													
if ( (not(_owner)) and (_a3 == 0) and isciv ) then {																																																												
...
player removeaction	INV_action_carfacablage;														
player removeaction INV_action_facherstellen;
player removeaction INV_action_facworkers;	
player removeaction INV_action_facworkers2;					
_a2 = 0;		};																								
