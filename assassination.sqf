...
_array  = [[CityLogic2, 200], [CityLogic4, 200], [CityLogic5, 80], [gunshop1, 200]];
...
player groupchat "The police are on to you and the VIP knows your coming for him, hurry up!";
...
while {true} do 
	...
	if (!alive VIPtarget and alive player) exitWith 
		...
		sleep 10;
		"server globalchat ""The VIP target has been murdered!"";" call broadcast;
		deletevehicle VIPtarget;
		deletemarker "targetmarker";
