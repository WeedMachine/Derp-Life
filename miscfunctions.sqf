...
if (_this) then 
 
	{
    	...
    	format["civ%1_mayor = 1;", rolenumber] call broadcast;
  
	} else {format["civ%1_mayor = 0;", rolenumber] call broadcast;};
...
if (_this) then 
 
	{
    	...
    	format["cop%1_chief = 1;", rolenumber] call broadcast;
  
	} else {format["cop%1_chief = 0;", rolenumber] call broadcast;};
...
if (_this) then 
 
	{
    	...
    	format["civ%1_bounty = 1;", rolenumber] call broadcast;
  
	} else {format["civ%1_bounty = 0;", rolenumber] call broadcast;};
